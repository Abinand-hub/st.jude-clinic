...
export const EditStaffModal: React.FC<EditStaffModalProps> = ({ user, onClose, onRefresh }) => {
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg border border-slate-200 overflow-hidden mt-10 mb-10 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-slate-50 border-b border-slate-200 px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-extrabold text-slate-900 tracking-tight">Edit Staff Details</h2>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 text-sm text-slate-900 transition-all font-mono"
